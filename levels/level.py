...
def assign_new_task(level: int, text_area_object=None):
    ...
    >>> assign_new_task(2)
    Your next task is making a Matcha. In order to make Matcha, in a mug, whisk together 1 teaspoon of matcha powder, 1 tablespoon of honey, and a splash of hot water to form a paste, then add ¾ cup of almond milk, whisk until combined, and enjoy your matcha latte!
